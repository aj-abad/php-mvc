...
Route::register(RequestMethod::GET, "/test/:id/add", HomeController::class, "test")->named("test1");
Route::register(RequestMethod::GET, "/:id/test", HomeController::class, "test")->named("test2");
